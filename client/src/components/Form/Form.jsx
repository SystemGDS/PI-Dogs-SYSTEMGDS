...
import Video from '../../assets/img/Copyright(720p).mp4'
            ...
            <div className={Styles.main}>
                <div className={Styles.formContainer}>
                    ...
                    <form autoComplete='off' >
                        ...
                        <button className={Styles.boton} onClick={e => handleAddTemperament(e)} title='Add'><GrFormAdd/></button>
                        ...
                        <button className={Styles.boton} onClick={e => handleReset(e)} title='Clear' id='remove'><BsTrash/></button>
                        <br></br><br></br>
                        ...
                        <div className={Styles.submitReset}>
                            <input className={Styles.boton} type='submit' disabled={isDisabled} name='submit' value='Create' onClick={handleSubmit}></input>
                            <input className={Styles.boton} type='reset' value='Reset' onClick={resetForm} title='Reset'></input>
                            <Link to='/home'><input className={Styles.boton} type='button' value='Back home'></input></Link>              
                        </div>
                    </form>
                    <br></br>
                </div>
